...
\newcolumntype{P}{>{\centering\arraybackslash\hsize=.25\hsize}X}
\newcolumntype{Q}{>{\centering\arraybackslash\hsize=.125\hsize}X}
\newcolumntype{M}{>{\centering\arraybackslash}m{\dimexpr.0865\linewidth-2\tabcolsep}}
\newcolumntype{N}{>{\centering\arraybackslash}m{\dimexpr.25\linewidth-2\tabcolsep}}
%\newcolumntype{O}{>{\centering\arraybackslash\hsize=.5\hsize}X}
\newcolumntype{O}{>{\centering\arraybackslash\hsize=.5\hsize}X}
...
%\newcommand{\spc}[1]{\mathbb{\mathbf{#1}}}
...
\newcommand{\STitle}{UGV \& UAV collaboration}
\newcommand{\SubTitle}{Bibliography}
\newcommand{\Date}{24.01.17}
\newcommand{\Time}{Wed 23:59}
\newcommand{\Recipient}{Prof. I. Taralova, Prof. O. Kermorgant, Prof. D. Marquez-Gamez}
